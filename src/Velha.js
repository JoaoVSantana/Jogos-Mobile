...
export default function Velha({
    ...
    const getPlayerUserName = () => player === "X" ? player1 : player2;
    return (
        <View>
            <Button color="#155CA2" title="Voltar" onPress={goBack} />

            <Text>
                É a vez do jogador : {getPlayerUserName()} - {player}
            </Text>
